                    ...
                    <ul id="iq-sidebar-toggle" class="iq-menu">
                        ...
                        <li class="">
                            ...
                            <ul id="employee" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                                ...
                                <li class="">
                                    <a href="salary-entries.php">
                                        <i class="las la-minus"></i><span>Salary Entry</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
                    ...
                    <div class="d-flex align-items-center ml-auto">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav ml-auto navbar-list align-items-center">
                                ...
                                <li>
                                    <a href="products.php" class="btn border add-btn shadow-none mx-2 d-none d-md-block">
                                        <i class="las la-plus mr-2"></i>Product
                                    </a>
                                </li>
                                <li class="nav-item nav-icon caption-content">
                                    <a href="#" class="search-toggle" data-toggle="modal" data-target="#my-profile">
